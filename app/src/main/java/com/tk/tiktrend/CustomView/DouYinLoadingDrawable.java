package com.tk.tiktrend.CustomView;
...
public class DouYinLoadingDrawable extends Drawable implements Animatable {
    ...
    public DouYinLoadingDrawable() {
        ...
        leftBallPaint.setColor(Color.parseColor("#00CACA"));
    ...
    public void draw(@NonNull Canvas canvas) {
        if (mCurrentDirection == Direction.LEFT) {
            ...
            canvas.save();
            rightBallPath.reset();
            rightBallPath.addCircle(centerX - radius + translate, centerY, radius, Path.Direction.CCW);
            canvas.drawPath(rightBallPath, rightBallPaint);
            canvas.restore();

            canvas.save();
            leftBallPath.reset();
            leftBallPath.addCircle(centerX + radius - translate, centerY, radius * scale, Path.Direction.CCW);
            canvas.drawPath(leftBallPath, leftBallPaint);
            canvas.restore();
